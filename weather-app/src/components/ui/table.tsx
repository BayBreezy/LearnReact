...
const table = tv({
  slots: {
    root: "**:data-drop-target:border-primary table w-full min-w-full caption-bottom border-spacing-0 text-sm outline-hidden [--table-selected-bg:color-mix(in_oklab,var(--color-primary)_5%,white_90%)] **:data-drop-target:border dark:[--table-selected-bg:color-mix(in_oklab,var(--color-primary)_25%,black_70%)]",
    header: "x32 border-b",
    row: "tr group bg-bg text-muted-fg ring-primary relative cursor-default border-b outline-hidden data-focus-visible:ring-1 data-focused:ring-0 data-selected:bg-(--table-selected-bg) data-selected:data-hovered:bg-(--table-selected-bg)/70 dark:data-selected:data-hovered:bg-[color-mix(in_oklab,var(--color-primary)_30%,black_70%)]",
    cellIcon:
