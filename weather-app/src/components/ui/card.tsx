...
const card = tv({
  slots: {
    root: [
      "xrkr xkd2 bg-bg text-fg **:data-[slot=table-header]:bg-muted/50 rounded-lg border shadow-xs has-[table]:overflow-hidden has-[table]:**:data-[slot=card-footer]:border-t **:[table]:overflow-hidden",
    ],
